...
\paragraph{Recurrence relations} Three-term recurrences build values from boundaries. Luscombe and Luban~\cite{luscombe1998three} developed a simplified recursive algorithm for Wigner 3j and 6j symbols. We derive closed forms for coefficients.
