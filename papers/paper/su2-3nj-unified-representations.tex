...
In this work we keep $C_G$ explicit and treat any identification with a particular Wigner convention as an additional, separately validated step (see the verification harness in \texttt{scripts/verify_wolfram.wls}).
...
The data that support the findings of this study are openly available in the Dawson Institute GitHub repositories at \texttt{https://github.com/DawsonInstitute/su2-3nj-series-paper} and related \texttt{su2-3nj-*} repositories. Supplementary material includes the full validation harness, reproducible test datasets, and scripts used to generate the tables included in this manuscript.
