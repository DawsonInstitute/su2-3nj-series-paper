...
% Theorem environments (amsart loads amsthm automatically)
...
\providecommand{\authorname}{Ryan Sherrington}%
\providecommand{\authoraffiliation}{Dawson Institute for Advanced Physics}%
\providecommand{\authoremail}{rsherrington@dawsoninstitute.org}%
...
\subjclass[2020]{Primary 33C80; Secondary 81R05}
\keywords{SU(2), recoupling coefficients, 3n-j symbols, generating functionals}
...
The theory of angular momentum recoupling has a rich seventy-year history. Wigner~\cite{wigner2013} established the foundation with 3j symbols, extended by Racah~\cite{racah1942} to 6j coefficients. The comprehensive treatise by Varshalovich et al.~\cite{varshalovich1988} systematized computational methods and remains the standard reference.
