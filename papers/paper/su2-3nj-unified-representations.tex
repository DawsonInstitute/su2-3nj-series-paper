...
% Theorem environments (after \begin{document} for RevTeX compatibility)
...
% Title and author (inside document for RevTeX compatibility)
...
\begin{itemize}
\item Hub repository: \url{https://github.com/DawsonInstitute/su2-3nj-series-paper}
\item Individual implementations: \url{https://github.com/DawsonInstitute/su2-3nj-*}
\end{itemize}
...
R. Sherrington: Conceptualization (lead); Formal analysis (lead); Investigation (lead); Methodology (lead); Software (lead); Validation (lead); Writing -- original draft (lead); Writing -- review \& editing (lead).

\section*{Data Availability}
The data that support the findings of this study are openly available in the following repositories: \url{https://github.com/DawsonInstitute/su2-3nj-series-paper} and associated \texttt{su2-3nj-*} repositories (validation scripts, reference JSON datasets at 50+ decimal precision, pytest harness, and generating functional implementations). High-precision reference values and cross-verification matrices are included as supplementary material in the arXiv ancillary files.
...
\begin{itemize}
\item \textbf{su2-3nj-closedform}: Hypergeometric product formula (\ref{thm:product})
\item \textbf{su2-3nj-uniform-closed-form}: Uniform ${}_5F_4$ representation (\ref{thm:uniform-12j})
\item \textbf{su2-3nj-recurrences}: Finite recurrence engine (\ref{thm:recurrence})
\item \textbf{su2-3nj-generating-functional}: Determinant-based generator (\ref{thm:generating-functional})
\item \textbf{su2-node-matrix-elements}: Operator matrix elements (\ref{thm:matrix-element})
\end{itemize}
